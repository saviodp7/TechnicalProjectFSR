...
def main():
    ...
    Test = tp.Traj_planning(path_list=gen_path_nodes())
    tesla = init_turtle()
    
    # test cartesian path
    optimal_path, path_length = Test.cartesian_traj(fs=30,profile_type=tp.TRAP_VEL_TYPE)
    #print(optimal_path)
    draw_nodes(optimal_path, tesla) 
